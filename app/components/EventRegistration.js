   ...
   return (
    ...
    <ScrollView >
      ...
      <View style={styles.hflex}>
          ...
          <View style={{alignItems:'flex-start',margin:5}}>
              <Text >Name</Text>
              <TextInput style={styles.item} defaultValue={username.username}  onChangeText={(text)=> setName({name:text})}/>
          </View>
      </View> 
      <View style={styles.hflex}>
          <View style={{alignItems:'flex-start',margin:5}}>
          ...
          <View style={{alignItems:'flex-start',margin:5}}>
              ...
              <TextInput style={styles.item} placeholder="Payment Ref" onChangeText={(text)=> setPaymentRef({paymentRef:text})}/>
          </View>
      </View>
      ...
      <View style={styles.hflex}>
          <View style={{alignItems:'flex-start',margin:5}}>
              ...
              <TextInput style={styles.item}
              placeholder={event.event_date} onChangeText={(text)=> setArrivalDate({arrivalDate:text})}/>
          </View>
          <View style={{alignItems:'flex-start',margin:5}}>
                <Text >Arrival Time</Text>
                <TextInput style={styles.item}
              placeholder={event.event_time} onChangeText={(text)=> setArrivalTime({arrivalTime:text})}/>               
          </View>
      </View>
      <View style={styles.hflex}>
          <View style={{alignItems:'flex-start',margin:5}}>
          ...
          <View style={{alignItems:'flex-start',margin:5}}>
                ...
                <TextInput style={styles.item}
              placeholder='Mode of Travel' onChangeText={(text)=> setModeOfTravel({modeOfTravel:text})}/>               
          </View>
      </View>
      <View style={styles.hflex}>
          <View style={{alignItems:'flex-start',margin:5}}>
